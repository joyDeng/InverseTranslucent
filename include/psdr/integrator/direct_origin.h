...
PSDR_CLASS_DECL_BEGIN(OldDirectIntegrator, final, Integrator)
public:
    OldDirectIntegrator(int bsdf_samples = 1, int light_samples = 1);
    virtual ~OldDirectIntegrator();
...
PSDR_CLASS_DECL_END(OldDirectIntegrator)
