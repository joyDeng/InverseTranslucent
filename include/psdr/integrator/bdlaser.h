...
PSDR_CLASS_DECL_BEGIN(BDLaserIntegrator, final, Integrator)
public:
    BDLaserIntegrator(int bsdf_samples = 1, int light_samples = 1);
    virtual ~BDLaserIntegrator();
...
PSDR_CLASS_DECL_END(BDLaserIntegrator)
