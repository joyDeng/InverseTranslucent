...
PSDR_CLASS_DECL_BEGIN(HeterSub, final, BSDF)
public:
    HeterSub() : 
    ...
    HeterSub(const Bitmap1fD &alpha, const Bitmap1fD &eta, const Bitmap3fD &reflectance, const Bitmap3fD &sigma_t, const Bitmap3fD &albedo)
        : 
    ...
    std::string to_string() const override { return std::string("HeterSub[id=") + m_id + "]"; }
